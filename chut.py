...
TELEGRAM_BOT_TOKEN = '7633868810:AAHP3bDPfpaEhx6ORytcitXMD642iVJlUFk'
ADMIN_USER_ID = 7357694692
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*💬 Owner: @DEVX76*\n"
        "*📢 Channel: [LOST NETWORK Channel](https://t.me/LOST9310)*"
    )
...
async def help_command(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    message = (
        "*❓ How to Use the @DEVX76 DDOS Bot?*\n\n"
        "*🔑 Commands:*\n\n"
        ...
        "*3. Contact the bot owner @DEVX76 for assistance or clarifications.*\n\n"
        "*⚡ Owner: @DEVX76*\n"
        "*📢 Channel: [@DEVX76 Channel](https://t.me/LOST9310)*"
    )
    await context.bot.send_message(chat_id=chat_id, text=message, parse_mode='Markdown')
...
async def approve(update: Update, context: CallbackContext):
    ...
    if chat_id != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ You need to get permission to use this command. Contact @DEVX76.*", parse_mode='Markdown')
        return
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*🤡 You need to get permission to use this bot. Contact owner @DEVX76.*", parse_mode='Markdown')
        return
